...
const char *gengetopt_args_info_usage = "Usage: star [OPTIONS]... [INPUT FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --time=DOUBLE  maximum time limit  (default=`3.154e7')",
  "  -s, --step=DOUBLE  minimum step value  (default=`1e-10')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->time_arg = 3.154e7;
  args_info->time_orig = NULL;
  args_info->step_arg = 1e-10;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->step_help = gengetopt_args_info_help[3] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* maximum time limit.  */


          if (update_arg( (void *)&(args_info->time_arg),
               &(args_info->time_orig), &(args_info->time_given),
              &(local_args_info.time_given), optarg, 0, "3.154e7", ARG_DOUBLE,
          ...
          break;
        case 's':	/* minimum step value.  */


          if (update_arg( (void *)&(args_info->step_arg),
               &(args_info->step_orig), &(args_info->step_given),
              &(local_args_info.step_given), optarg, 0, "1e-10", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "step", 's',
              additional_error))
            goto failure;
